...
const float JUMP_FORCE = 0.0006f;
...
public:
    ...
    void ResolveCollisions(Object& pl) {
...
int APIENTRY wWinMain(HINSTANCE hI, HINSTANCE hP, LPWSTR lp, int nS) {
    ...
    HWND hWnd = CreateWindowW(L"LevelEd", L"Map Fitting Screen", WS_OVERLAPPEDWINDOW, 100, 100, 1290, 790, 0, 0, hI, 0);
    ...
    windowWidth = 1280; windowHeight = 720; // Временные для инициализации
    float aspect = (float)windowWidth / windowHeight;
